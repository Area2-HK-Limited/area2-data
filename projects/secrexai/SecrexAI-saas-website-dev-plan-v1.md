# PersonAI SaaS 官方網站 — 開發計劃書 v1.2

**產品：** PersonAI — 香港 SME 專屬 WhatsApp AI 助手  
**推出主體：** Hostlink (HK) Limited × Area2 (HK) Limited 聯乘  
**文件類型：** 網站前端開發計劃書  
**版本：** v1.2 — 2026-03-22（改用 Tencent Lighthouse Cloud 日本地區作為伺服器基礎設施）  
...
| 怕業務資料外洩，唔敢用 AI | 數據去咗美國，受美國法律管 | 數據存放亞太區（日本），唔受美國 CLOUD Act 管轄 |
...
│  │ [睇互動示範]             │                            │
│  └─────────────────────────┘                            │
│  信任標誌：Hostlink × Area2 | PDPO 合規 | Tencent Cloud 亞太數據中心（日本）│
├─────────────────────────────────────────────────────────┤
│                                                         │
│  痛點共鳴 SECTION (白底)                                 │
│  「你係咪都有呢幾個問題？」                               │
...
│                                                         │
│  ❓ 顧慮：數據存喺邊？                                     │
│  ✅ 答案：100% 亞太區（日本），Tencent Cloud 企業級數據中心 │
│           唔係美國，唔受 CLOUD Act 管轄                     │
│                                                         │
│  ❓ 顧慮：員工對話會唔會洩漏？                              │
│  ✅ 答案：端到端加密 + 每個用戶帳號獨立隔離                 │
│                                                         │
│  ❓ 顧慮：香港法律管唔管到？                                │
│  ✅ 答案：PDPO 合規（香港公司運營），日本 APPI 嚴格保護，    │
│           香港本地公司運營，可簽 DPA                        │
├─────────────────────────────────────────────────────────┤
│ Tencent Cloud 亞太數據中心（日本）Section                    │
│ [圖片：現代數據中心機架插圖]                               │
│ ISO 27001 | SOC 2 Type 2 | CSA STAR | PDPO | APPI | 企業級防火牆│
├─────────────────────────────────────────────────────────┤
│ 競品安全比較表                                             │
├─────────────────────────────────────────────────────────┤
...
- 如何使用資料（服務提供、技術支援）
- 資料儲存位置（Tencent Cloud 亞太數據中心，日本地區；不存放於美國）
- 資料保留期限
...
香港特別行政區 | 受 PDPO 保護 | 數據 100% 亞太區，絕不經美國
```
