...
2. **✅ 雙重確認 — 定價競爭力嚴重不足**：PersonAI Starter 定價 HK$298/月，比 ChatGPT Plus（~HK$156，USD$20）貴 **91%**。在未能建立顯著品牌認知的情況下，溢價說服難度極高。除非能證明「廣東話 + 永久記憶 + 自動化任務」能帶來超過 HK$150/月 的生產力增值，否則難以說服大眾用戶。
...
- **定價必須大幅下調**（A+B 線共識）：HK$298 Starter 價位無法與 HK$156 的 ChatGPT Plus 競爭
...
|---|---|---|---|---|---|
| **ChatGPT Plus** | ~$156 | GPT-4o/GPT-5, DALL-E, Web Search, Memory | Web/App | 全球最強品牌、最大用戶基數（8.78億 MAU）| 無 WhatsApp 原生（Business API 已禁）、廣東話一般 |
| **Claude Pro** | ~$156 | Claude 3.5/3.7 Sonnet, 200K context | Web/App | 長文分析最強，寫作質量高 | 無 App 整合、香港需 VPN |
| **Google Gemini Advanced** | ~$156 | Gemini 1.5/2.0 Pro, Workspace 整合, 1M token | Web/App/Gmail | Google 生態深度整合、2TB 存儲 | 推理不穩、本地化弱 |
| **Microsoft Copilot Pro** | ~$156 | GPT-4o + Office 365 整合 | Word/Excel/Teams | 企業 Office 深度整合 | 不適合個人、非 WhatsApp |
| **Meta AI** | **免費** | LLaMA 4, WhatsApp/Instagram 原生 | **WhatsApp(!)** | **免費**、WhatsApp 原生、30億用戶 | 廣東話一般、無記憶系統 |
| **Manus AI** | ~$156-$312 | General Purpose Agent, 任務自動化 | 網頁/App | 中國爆紅、Credit 制 | 收費混亂、無 WhatsApp |
| **PersonAI Starter** | **$298** | AI助手+永久記憶+廣東話+60+技能 | WhatsApp（個人）| 廣東話優化、記憶系統 | 初創、定價貴 91% |
| **PersonAI Business** | **$680** | 進階模型+1500次任務/月 | WhatsApp（個人）| 中小企方案 | 定價偏高 |
...
*PersonAI 市場研究報告 v4.1（2026-03-20 修正版）| 研究員：A2 AI Agent | 2026-03-20*
